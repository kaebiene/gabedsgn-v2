...
const Area = styled(animated.div)`
  ...
  grid-template-areas:
    ...
    'fourth-project fourth-project fourth-project';
  ...
  @media (max-width: ${props => props.theme.breakpoints[3]}) {
    ...
    grid-template-areas:
      ...
      'three-projects three-projects three-projects three-projects'
      'fourth-project fourth-project fourth-project fourth-project';
  }
...
const FourthProject = styled(GridItem)`
  grid-area: fourth-project;
`

const Index: React.FunctionComponent<PageProps> = ({ data: { firstProject, threeProjects, aboutUs, fourthProject } }) => {
  ...
  return (
    <Layout>
      ...
      <Area style={pageAnimation}>
        ...
        <FourthProject to="/uniwaves" aria-label="View project uniwaves">
          <Img fluid={fourthProject.childImageSharp.fluid} />
          <span>Uniwaves</span>
        </FourthProject>
      </Area>
    </Layout>
...
export const query = graphql`
  query Index {
    ...
    fourthProject: file(sourceInstanceName: { eq: "images" }, name: { eq: "Triangles" }) {
      childImageSharp {
